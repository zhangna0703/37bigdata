      ...
      <div class="solution">
        <div class="solution-section">
          ...
          <div class="solution-navMenu">
            <!-- <el-tabs v-if="solutionMenu" v-model="solutionMenu" @tab-click="tabClick">
              <el-tab-pane v-for="(item) of navMenuDtat" :key="item.id" :label="item.title" :name="item.id">{{item.title}}</el-tab-pane>
            </el-tabs> -->
