  ...
  data () {
    return {
      ...
      characteristic: [
        {
          tit: '提供丰富的图表类型',
          content: '50余种图表类型，涵盖柱形图、双轴图、漏斗图、帕累托图等。在此基础上，延展出投屏、幻灯片等数据可视化呈现形式，满足绝大多数数据表达需求。'
        }, {
          tit: '提供丰富的数据交互分析操作',
          content: '如钻取、联动、跳转，一键点击 即可层层剖析数据，发现问题。'
        }, {
          tit: '可根据业务、角色，快速搭建数据驾驶舱',
          content: '在垂直领域提炼通用的分析思路和模板，即刻接入您的数据，借鉴行业最佳数据分析实践，并进行自由排版布局。'
        }
      ]
    }
  },
