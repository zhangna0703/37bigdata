<template>
  <div>
    ...
    <div class="contents">
      <!-- 物联网 -->
      <div class="iotCore" v-if='flag==true'>
        <div class="lefts">
          <h2>物联网客户案例</h2>
        ...
        <ul class="rights">
          <li v-for='(item,index) in imagelist' :key='index'><img :src="item" alt=""></li>
        </ul>
      </div>
      <!-- 大数据 -->
